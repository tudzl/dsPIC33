...
## dsPIC33AK128MC FreeRTOS Demo

contains the freeRTOS demos modified for dsPIC33AK128MC106 DIM + Curiosity board platfrom, need test,
Codes is based on original official freeRTOS demo.
Modified by Zell(Zell.Zhou@microchip.com), Sep.2025
UART task tested OK， 7.Sep.2025
